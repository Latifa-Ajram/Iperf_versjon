...
def client(serverip, port, format,duration,parallel,interval,num):# Dette er funksjon for å kjøre client
...
if __name__ == '__main__':# sjekker navnet på det gjeldende programmet som kjøres, og koden inne i blokken, er det den som skal kjøres. Linjen er brukt for å kjøre koden
    ...
    if args.num:
        ...
        unit_factors={"B":1,"KB":1024,"MB":1024*1024}
        num = num_value * unit_factors[num_unit] #convert to bytes
